/**
 * \example parrot_visualizer.c
 *
 * PolySync data handling, visualization and control example.
 *
 *
 */
...
int main( int argc, char *argv[] )
{
    ...
    while( 1 )
    {
        ...
        publish_current_vehicle_position( node_data, 
                node_data->vehicle_cmds, 
                &gui->vehicle_position );
